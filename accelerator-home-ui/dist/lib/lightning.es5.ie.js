  ...
  function () {
    ...
    _createClass(Utils, null, [{
      ...
      value: function equalValues(v1, v2) {
        if (_typeof(v1) !== _typeof(v2)) return false;
  ...
  function (_Component) {
    ...
    _createClass(Application, [{
      ...
      value: function _receiveKeydown(e) {
        ...
        if (key) {
          if (!this.stage.application.focusTopDownEvent(["_capture".concat(key), "_captureKey"], obj)) {
            this.stage.application.focusBottomUpEvent(["_handle".concat(key), "_handleKey"], obj);
          }
        } else {
      ...
      value: function _receiveKeyup(e) {
        ...
        if (key) {
          if (!this.stage.application.focusTopDownEvent(["_capture".concat(key, "Release"), "_captureKeyRelease"], obj)) {
            this.stage.application.focusBottomUpEvent(["_handle".concat(key, "Release"), "_handleKeyRelease"], obj);
          }
        } else {
